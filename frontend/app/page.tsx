    ...
    <div className="space-y-6">
      ...
      <div className="border-b border-slate-800/80 pb-5">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-2 px-2.5 py-0.5 rounded bg-sky-950/40 border border-sky-800/40 text-sky-300 text-[11px] font-medium font-sans tracking-wide mb-2">
          ...
          <div className="flex flex-wrap items-center gap-2 text-xs font-sans shrink-0">
            <div
              className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#0d121d] border border-slate-800 text-slate-300 text-[11px] font-medium"
              title="AI agents can inspect evidence but cannot modify financial records."
            >
              <Lock className="w-3 h-3 text-sky-400" />
              <span>Read-only AI Boundary</span>
            </div>
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-[#0d121d] border border-slate-800 text-slate-300 text-[11px] font-medium">
